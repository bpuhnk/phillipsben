  ...
  return (
    <>
      <section className="section" style={{ paddingBottom: 64 }}>
        ...
        <h1 className="display display-xxl contact-page-h1" style={{ marginTop: 24, marginBottom: 32 }}>
          Let's <i>talk.</i>
        </h1>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="contact-tile-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          ...
          >
            <div className="meta tile-kicker" style={{ marginBottom: 14 }}>① &nbsp; EMAIL</div>
            <h3 className="tile-headline" style={{ fontFamily: 'var(--font-display)', fontSize: 40, lineHeight: 1, marginBottom: 12 }}>
              contact@<br />phillipsben.<i>com</i>
            </h3>
            <p className="tile-body" style={{ fontSize: 13.5, color: 'var(--ink-2)' }}>
          ...
          <a
            ...
            style={{ display: 'block', padding: 32, border: '1px solid var(--rule)', background: 'var(--bg)' }}
          >
            <div className="meta tile-kicker" style={{ marginBottom: 14 }}>② &nbsp; CALENDAR</div>
            <h3 className="tile-headline" style={{ fontFamily: 'var(--font-display)', fontSize: 40, lineHeight: 1, marginBottom: 12 }}>
          ...
          >
            <div className="meta tile-kicker" style={{ marginBottom: 14, color: 'rgba(250,248,244,.5)' }}>③ &nbsp; RÉSUMÉ</div>
            <h3 className="tile-headline" style={{ fontFamily: 'var(--font-display)', fontSize: 40, lineHeight: 1, marginBottom: 12 }}>
              Download <i>PDF</i><br />résumé →
            </h3>
            <p className="tile-body" style={{ fontSize: 13.5, color: 'rgba(250,248,244,.6)' }}>
      ...
      <section className="section">
        ...
        <ul className="contact-elsewhere" style={{ listStyle: 'none', padding: 0, margin: 0 }}>
          {[
            ...
            >
              <span className="meta elsewhere-kicker">{k}</span>
              <a href={href} target="_blank" rel="noreferrer" className="elsewhere-value" style={{ fontFamily: 'var(--font-display)', fontSize: 26 }}>{v}</a>
              <span className="elsewhere-desc" style={{ fontSize: 13.5, color: 'var(--ink-2)' }}>{d}</span>
              <a href={href} target="_blank" rel="noreferrer" className="elsewhere-arrow" style={{ fontFamily: 'var(--font-mono)', fontSize: 14, color: 'var(--accent)', textAlign: 'right' }}>↗</a>
            </li>
          ))}
        </ul>
      </section>
